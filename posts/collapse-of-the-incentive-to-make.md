...
2. People find it;
3. The effort pays off.

But when a model can scrape your article, summarize it and hand the answer to someone who never visits your site, that deal is dead, and that collapse creates a weird second-order problem[^secondorder].
